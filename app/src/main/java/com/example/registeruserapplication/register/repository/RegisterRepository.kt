package com.example.registeruserapplication.register.repository

import com.example.registeruserapplication.networking.Resource
import com.example.registeruserapplication.register.data.ApiServices
import com.example.registeruserapplication.register.data.delete.DeleteResponse
import com.example.registeruserapplication.register.data.getprofile.GetAllProfileResponse
import com.example.registeruserapplication.register.data.getprofile.ProfileResponse
import com.example.registeruserapplication.register.data.post.PostResponse
import com.example.registeruserapplication.register.data.post.PostResult
import com.example.registeruserapplication.signin.data.SignUpPostResponse
import com.example.registeruserapplication.signin.data.UserSignUpPostResult
import com.example.registeruserapplication.signin.data.login.SignInResponse
import com.example.registeruserapplication.signin.data.login.SignInResult
